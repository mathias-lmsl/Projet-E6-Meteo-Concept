...
void setup() {
    ...
    attachInterrupt(windSpeedINT, readWindSpeed, FALLING);// détecter les changements d'état de l'anémomètre sur front descendant
    pinMode(windDirPin, INPUT);
    attachInterrupt(windDirINT, readWindDir, FALLING); // détecter les changements d'états d ela girouette sur front descendant
    interrupts();
}
